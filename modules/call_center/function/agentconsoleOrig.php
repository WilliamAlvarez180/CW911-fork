...
/* vim: set expandtab tabstop=4 softtabstop=4 shiftwidth=4:
  ...
  +----------------------------------------------------------------------+
  $Id: new_campaign.php $ */
require_once $modLibDir . "paloSantoForm.class.php";
require_once $modLibDir . "libs/paloSantoTrunk.class.php";
require_once $modLibDir . "libs/paloSantoConfig.class.php";
