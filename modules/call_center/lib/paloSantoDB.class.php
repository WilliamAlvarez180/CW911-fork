...
class paloDB {
     ...
     */
    public function __construct($dsn) // Creo que aqui debo pasar el dsn
    {
        ...
        if (is_object($dsn)) {
            ...
            try {
                ...
                $this->errMsg = "Error de conexion a la base de datos mysql	- " . $e->getMessage();
...
//        if (get_magic_quotes_gpc()) $sVal = stripslashes($sVal);
    ...
    function parseDSN($dsn)
    {
        ...
        //if (!count($dsn)) {
        //    return $parsed; DESHABILITADO POR RAZONES DE COMPATIBILIDAD CON cw911
        //}
