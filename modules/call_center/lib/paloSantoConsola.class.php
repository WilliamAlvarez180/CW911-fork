...
$PBXHost = $vars["modCFG"]["config"]["PBXHost"];
...
class PaloSantoConsola
{
    ...
    private function _obtenerConexion($sConn)
    {
        ...
        case 'asterisk':
            ...
            $sDSN = $vars["modCFG"]["config"]["AMPDBEngine"] ."://".
					$vars["modCFG"]["config"]["AMPDBUser"] .":".
					$vars["modCFG"]["config"]["AMPDBPass"] ."@".
					$vars["modCFG"]["config"]["PBXHost"] ."/asterisk";
            $oDB = new paloDB($sDSN);
            if ($oDB->connStatus) {
        ...
        case 'call_center':
            ...
            $sDSN = $vars["modCFG"]["config"]["AMPDBEngine"] ."://".
					$vars["modCFG"]["config"]["AMPDBUser"] .":".
					$vars["modCFG"]["config"]["AMPDBPass"] ."@".
					$vars["modCFG"]["config"]["PBXHost"] . "/call_center";
            $oDB = new paloDB($sDSN);
            if ($oDB->connStatus) {
                $this->_errMsg = '(internal) Unable to create asterisk DB conn - '.$oDB->errMsg;
                die($this->_errMsg);
        ...
        case 'ECCP':
            ...
            $sUsernameECCP = $vars["modCFG"]["config"]["ECCPUser"];
            $sPasswordECCP = $vars["modCFG"]["config"]["ECCPPass"];
            ...
            $cr = $oECCP->connect($vars["modCFG"]["config"]["PBXHost"], $sUsernameECCP, $sPasswordECCP);
            if (isset($cr->failure)) {
    ...
    function estadoAgenteLogoneado($sExtension)
    {
        try {
            ...
            if ($estado['status'] == 'offline') {
                ...
                $this->errMsg = 'Specified agent already connected to extension'.
...
*/
    ...
    function colgarLlamada()
    {
        try {
            ...
            if (isset($respuesta->failure)) {
                $this->errMsg = $this->_formatoErrorECCP($respuesta);
                return FALSE;
            }
            return TRUE;
        } catch (Exception $e) {
    ...
    function listarBreaks()
    {
        try {
            ...
            if (isset($respuesta->failure)) {
                $this->errMsg = 'Unable to fetch break types - '.$this->_formatoErrorECCP($respuesta);
                return NULL;
            }
            $listaPausas = array();
    ...
    function leerInfoCampania($sCallType, $iCampaignId)
    {
        if ($sCallType == 'incomingqueue') {
            ...
            if (isset($respuesta->failure)) {
                $this->errMsg = 'Unable to read call information - '.$this->_formatoErrorECCP($respuesta);
                return NULL;
            }
    ...
    function leerScriptCola($queue)
    {
        try {
            ...
            if (isset($respuesta->failure)) {
                $this->errMsg = 'Unable to read queue script - '.$this->_formatoErrorECCP($respuesta);
                return NULL;
            }
    ...
    function confirmarContacto($idCall, $idContact)
    {
        try {
            ...
            if (isset($respuesta->failure)) {
                $this->errMsg = 'Unable to set contact - '.$this->_formatoErrorECCP($respuesta);
                return FALSE;
            }
            return TRUE;
        } catch (Exception $e) {
        ...
        $calltype = NULL, $callid = NULL)
    {
        try {
            ...
            if (isset($respuesta->failure)) {
                $this->errMsg = 'Unable to schedule call - '.$this->_formatoErrorECCP($respuesta);
                return FALSE;
            }
            return TRUE;
        } catch (Exception $e) {
    ...
    function guardarDatosFormularios($sTipoLlamada, $idLlamada, $datosForm)
    {
        try {
            ...
            if (isset($respuesta->failure)) {
                $this->errMsg = 'Unable to save form data - '.$this->_formatoErrorECCP($respuesta);
                return FALSE;
            }
            return TRUE;
        } catch (Exception $e) {
    ...
    function leerEstadoCampania($sCallType, $iCampaignId, $datetime_start = NULL)
    {
        try {
            ...
            if (isset($respuesta->failure)) {
                $this->errMsg = 'Unable to read campaign information - '.$this->_formatoErrorECCP($respuesta);
                return NULL;
            }
    ...
    function leerLogCampania($sCallType, $iCampaignId, $lastN = NULL, $idbefore = NULL)
    {
        try {
            ...
            if (isset($respuesta->failure)) {
                $this->errMsg = 'Unable to read campaign log - '.$this->_formatoErrorECCP($respuesta);
                return NULL;
            }
